...
class App(Frame):
    def __init__(self, master):
        ...
        self.button1 = Button(master, text="------ Anim.", fg="black", bg="lightblue", bd=2, height=3, font=("Helvetica", 14, "bold"), command = openImageCapture)
        self.button1.pack(side=TOP, fill=X, pady=5)

        self.button2 = Button(master, text="------ Anim.", fg="white", bg="red", height=3, font=("Helvetica", 14, "bold"), command = openPreBuilt)
